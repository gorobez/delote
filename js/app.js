(() => {
    ...
    function menuInit() {
        if (document.querySelector(".icon-menu")) document.addEventListener("click", (function(e) {
            ...
            if (bodyLockStatus && e.target.closest(".menu__link")) document.documentElement.classList.remove("menu-open");
...
***************************************************************************** */
    ...
    da.init();
    const buttons = document.querySelectorAll(".categories-our-work__item");
    const cards = document.getElementsByClassName("our-work__item");
    ...
    document.addEventListener("click", (e => {
        if (e.target.closest(".categories-our-work__item")) {
    ...
    function initMap() {
        let pos = {
            lat: 51.50807654678213,
            lng: -.14087910105491744
        };
